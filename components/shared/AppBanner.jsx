  ...
  return (
    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        >
          <a
            download="Daiwik-resume.pdf"
            href="files/DaiwikResumeShort.pdf"
      ...
      <motion.div
        ...
        transition={{ ease: "easeInOut", duration: 0.9, delay: 0.2 }}
        className="w-full sm:w-2/3 flex justify-center items-center text-right float-center mt-8 sm:mt-0"
      >
        <img
